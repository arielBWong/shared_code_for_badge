function [saved_result, net] = UL_Evolution_v2(Params, prob, generation_pop, strategy, funchn, termination_criterion, net, saved_result, gen_gap, varargin)
%-
...
%         %----figure  example
%          if gen == 2
%             LL_prediction_visualization(2, prob, net, Params);
%           return;
%         end
    % else
...
% scatter(nd(:, 1), nd(:, 2), 20, [0.8500 0.3250 0.0980], 'filled', 'DisplayName', 'ND front');
pop = pop .* -1;
