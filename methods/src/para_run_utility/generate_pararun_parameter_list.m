function [onerun_parameters, num_runs] = generate_pararun_parameter_list(prob_list, max_seed, trg_size_list, gen_gap_list, strategy_structure, save_batch_id, UL_termination_id)
    ...
    for  gg = 1:length(gen_gap_list)
        ...
        for i = 1 : np
            for j = 1 : ns
                ...
                onerun_parameters(strc_id). seed = seeds(j);
                onerun_parameters(strc_id). strategy = strategy_structure;
