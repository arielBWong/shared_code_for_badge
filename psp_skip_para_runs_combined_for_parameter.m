...
warning("off");
batch_id = 2220;     % 20000, compare to state of the art experiment    2200/2000/200/20 parameter
trg_size = [500, 1000, 2000, 5000];         % parameters experiments remember to change stopping condition to IGD                          
gen_gap = [5, 10, 15, 20, inf];  

strategy.name = "net2skipLLsearch";
strategy.handle = '@(x, net,skip_flag)net_for_periodLL_search(x, prob, Params, net, 1, skip_flag)';% 1-IGD 2-HV
